...
export type PreferenceStore = { dataDirPath: string; theme: Theme; themeColor: string; language: LanguageCode; deleteOnImport: boolean; useUnitypackageSelectedOpen: boolean; updateChannel: UpdateChannel }
